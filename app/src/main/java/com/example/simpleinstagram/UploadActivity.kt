...
import com.example.simpleinstagram.databinding.ActivityUploadBinding
...
class UploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.uploadToolbar.setOnClickListener {
    ...
    fun select_image (view:View) {
        ...
        if(ContextCompat.checkSelfPermission(this,Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) { // izin yoksa

            if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)) { // neden izin istenildiğini açıklamamız gerekiyor
            ...
            val intentToGallery = Intent(Intent.ACTION_PICK,MediaStore.Images.Media.EXTERNAL_CONTENT_URI) // Galeriye git ve oradan bir veri al
